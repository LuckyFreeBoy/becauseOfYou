                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" class="sm" placeholder="导航别名" name="nav_alias" value="{{old('nav_alias')}}">
                    ...
                    <tr>
                        ...
                        <td>
                           <input type="text" size="50" name="nav_url" value="{{old('nav_url')?old('nav_url'):'http://'}}">
                    ...
                    <tr>
                        <th>排序：</th>
                        <td>
                           <input type="text" class="sm" name="nav_order" value="{{old('nav_order')?old('nav_order'):0}}">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
