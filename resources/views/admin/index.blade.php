...
@section('content')
	...
	<div class="menu_box">
		<ul>
            ...
            <li>
                ...
                <ul class="sub_menu" style="display: block;">
                	<li><a href="{{ url('admin/link')}}" target="main"><i class="fa fa-fw fa-support"></i>友情链接</a></li>
                	<li><a href="{{ url('admin/nav')}}" target="main"><i class="fa fa-fw fa-send"></i>自定义导航</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2015. Powered By <a href="http://www.olderwang.com">http://www.olderwang.com</a>.
	</div>
	<!--底部 结束-->
@endsection()