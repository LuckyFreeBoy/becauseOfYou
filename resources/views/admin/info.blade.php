...
@section('content')
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{ url('admin/article') }}" target="main"><i class="fa fa-align-justify"></i>全部文章</a>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="http://www.olderwang.com">http://www.olderwang.com</a></span>
                </li>
                <li>
