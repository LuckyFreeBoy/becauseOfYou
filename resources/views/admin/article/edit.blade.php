            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="{{$art->art_thumb}}" id="art_thumb_img" alt="" style="max-width: 360px;max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <textarea name="art_tag">{{$art->art_tag}}</textarea>
                            {{-- <p>这里可以做简单的描述</p> --}}
                        </td>
                    </tr>
                    <tr>
                        <th>描述：</th>
                        <td>
                            <textarea class="lg" name="art_description">{{$art->art_description}}</textarea>
                            {{-- <p>这里可以做简单的描述</p> --}}
                        </td>
                    </tr>
                    <tr>
